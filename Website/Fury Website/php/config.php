<?
	...
	define('TO_NAME','Chris');  //put your name
	define('TO_EMAIL','chrprice@microsoft.com');  //put your email
	...
	define('SUBJECT','Contact from your Fury website'); //change if you want the subject
